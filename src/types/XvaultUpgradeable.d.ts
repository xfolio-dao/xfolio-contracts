...
interface XvaultUpgradeableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "transferXFL(address,uint256)": FunctionFragment;
  };
...
export class XvaultUpgradeable extends BaseContract {
  ...
  interface: XvaultUpgradeableInterface;
